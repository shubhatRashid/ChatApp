...
const ChatBubble = ({message,position}) => {
  return (
    <div  className={`flex justify-${position} py-[0.3%] px-[0.5%] space-x-4 mr-[1%] `} >
        ...
        <div className={`${position==="start"?"bg-teal-800 text-white":"bg-gray-50 text-black"} border  rounded-lg ${position==="end"?"rounded-tr-none":"rounded-tl-none"} mx-[2%]  my-[0.5%] p-[1%] max-w-[70%]`}>
