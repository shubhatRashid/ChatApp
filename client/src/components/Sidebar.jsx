...
const Sidebar = ({homeFun,chatFun,searchFun,logoutFun}) => {
  ...
  return (
        <div className='absolute bottom-0 left-0 sm:relative z-10 sm:z-0  flex sm:flex-row flex-col justify-around h-[70px] sm:h-full w-full sm:w-[70px] rounded-none sm:rounded-xl bg-gray-200'>
