...
const Chats = () => {
  ...
  const [seeNav,setSeeNav] = useState(false)    // determines if navbar if visible //
  const [seeChat,setSeeChat] = useState(true)   // determines if div containing all chats if visible //
  const [showSearch,setShowSearch] = useState(false)  // determines if searchbar in all chats is visible //
    ...
    <div className='chatsPage flex flex-row justify-center h-screen'>
        ...
        <div className={`${seeNav?'flex':'hidden'} sm:flex flex-col justify-between items-center bg-[#116D6E] my-[2%] mx-[2%] rounded-lg ml-[2%] px-[1%] w-[60px] py-[2%]`}>
            ...
            <div className='flex flex-col'>
              ...
              <Button src="https://cdn.lordicon.com/zniqnylq.json" size= '45px' clickFun={() => {setShowSearch(!showSearch)}} />
        ...
        <div className={`${usersDiv?"flex":"hidden"} flex-col my-[2%] rounded-lg bg-green-50 w-[550px]`}>
              ...
              <div className='flex flex-col justify-between h-[65%]'>
                  ...
                  <div className='flex flex-col items-start ml-[5%] mt-[5%]'>
                        ...
                        <div className={`${showSearch?'flex':"hidden"} ml-[-3%] w-[100%]`}>
                          <Search placeholder='Search chat...' />
                        </div>
        ...
        <div className={`${usersDiv?"hidden":"flex"} md:${seeChat?'flex':'hidden'}  flex-col justify-between min-w-[40%] w-screen  bg-green-50 my-[2%] mx-[1%] rounded-lg ml-[2%] px-[1%] pt-[1%]`}>
            ...
            <div className='border min-h-[80%] mt-[2%] rounded-lg bg-white '>
                  ...
                  {/* NAME AND PHOTO */}
                  <div className='flex items-center border-b-4 rounded-lg h-[20%] '>
